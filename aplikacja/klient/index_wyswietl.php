...
<head>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="content">
                <span class="bigtitle">Wyświetlanie klientów</span>
                <div style="height: 15px;"></div>

                <form method="POST">
                    <input type="submit" name="Wyswietl_all" value="Wyświetl wszystkich klientów">
                </form>
                <br><br>
                <?php
                ...
                <br><br>
                <div id="form2">
                <span class="bigtitle">Wyszukiwanie klientów</span>
                <h3><b>Wpisz nazwę klienta, którego chcesz wyszukać:</b></h3>
                <form method="POST">
                    <input type="text" name="szukajInput" maxlength="100" placeholder="nazwa klienta">
