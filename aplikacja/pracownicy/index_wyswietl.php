...
<head>
    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="content">
                <span class="bigtitle">Wyświetlanie pracowników</span>
                <div style="height: 15px;"></div>

                <form method="POST">
                    <input type="submit" name="Wyswietl_all" value="Wyświetl wszystkich pracowników">
                </form>
                <br><br>
                <?php
                ...
                <div id="form2">
                    <span class="bigtitle">Wyszukiwanie pracowników</span>
                    <h3><b>Wpisz nazwisko pracownika, którego chcesz wyszukać:</b></h3>
                    <form method="POST">
                    ...
                    if(isset($_POST['szukaj'])){
                        ...
                        if($db){
                            ...
                            if(empty($searchInput)){
                                ...
                                echo "<b>Taki pracownika nie istnieje.</b>";
                            }else {
                                echo "<br>";
                                echo"<table>";
                                    echo "<tr>";
